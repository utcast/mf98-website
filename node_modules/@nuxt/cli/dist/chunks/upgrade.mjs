...
import { c as cwdArgs, l as logLevelArgs, b as legacyRootDirArgs, a as logger } from '../shared/cli.DWe7ol-H.mjs';
import { c as cleanupNuxtDirs, n as nuxtVersionToGitIdentifier } from '../shared/cli.yR2Mj6Rb.mjs';
...
Please either add the \`packageManager\` field to \`package.json\` or execute the installation command for your package manager. For example, you can use \`pnpm i\`, \`npm i\`, \`bun i\`, or \`yarn i\`, and then try again.`
    ...
    let method = ctx.args.force ? "force" : ctx.args.dedupe ? "dedupe" : undefined;
