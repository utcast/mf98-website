...
import ScheduleModal from '@/components/en/ScheduleModal.vue'
...
<div class="grid" :style="`grid-template-columns: 80px repeat(4, 1fr)`">
  ...
  <!-- ショー・アトリエ -->
  <div class="border-r text-center text-xs  bg-blue-500 text-white">Show</div>
  <div class="border-r text-center text-xs  bg-blue-500 text-white">Atelier</div>
  <div class="border-r text-center text-xs  bg-blue-500 text-white">Show</div>
  <div class="text-center text-xs  bg-blue-500 text-white">Atelier</div>
</div>
        ...
        >
          ...
          >
            <div class="font-bold text-[9px]">
              <T :v="schedule.kikakuInfo.title_short_en" />
            </div>
